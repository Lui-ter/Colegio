...
<style>
    ...
    <div class="container1">
        <div class="titulo">
            <h3>Papeleria cursos</h3> 
        </div>
        <a href="{{url('curso_interfaz')}}"><button>Volver</button></a>
        <div class="tabla">
            <table border="1">
                <tr>
                    <td>Id</td>
            ...
            @foreach ( $cursos as $curso )
                <tr>
                    ...
                    <td><a href="{{ url('curso_recuperar/'. $curso->id_curso)}}" onclick="return confirm('¿Estas seguro de recuperar el campo?')">Recuperar</a></td>
